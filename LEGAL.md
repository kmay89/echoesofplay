...
By using Echoes of Play, you acknowledge the following. We've written it plainly because you deserve to understand what you're agreeing to.

---

## 1. This is a playground, not a clinical tool
...
Everything you write stays on your device. We have no access to it. We have no copy of it. We cannot recover it if you delete it or clear your browser data.
...
- Everything captured stays on your device. You control what is exported and shared.
...
Echoes of Play is licensed under Apache 2.0. You may fork, modify, and redistribute it. If you do:

- The privacy, cookie, and legal policies in this repository apply only to the unmodified application served at echoesofplay.com.
- If you add network connections, analytics, data collection, AI capabilities, or any other functionality not present in the original, you must update all policies to reflect your changes.
- You must not represent your modified version as having the same privacy guarantees as the original unless those guarantees are architecturally preserved.
- Attribution to ERRERlabs and Karl Meves is appreciated but not required beyond what Apache 2.0 specifies.

## 5. No warranty

This software is provided "as is" without warranty of any kind, express or implied. We do not guarantee that it will work on every device, that it will be available at all times, or that it will meet your specific needs.

We have done our best. But honest means honest: we cannot promise perfection.

## 6. Limitation of liability

To the maximum extent permitted by law, ERRERlabs and Karl Meves shall not be liable for any damages arising from the use of this application. This includes but is not limited to: loss of data (your browser may clear localStorage), emotional distress, reliance on non-clinical content, or actions taken based on any content within the application.

This limitation exists not because we don't care, but because we are a playground, not a professional service, and the boundary matters.

## 7. No account, no age gate

There is no account system. There is no login. There is no age verification. The application collects no information that could identify a user's age.

Parents and guardians: the application contains no advertising, no social features, no external links beyond errerlabs.com, no in-app purchases, and no data collection. Content is reflective and contemplative in nature.
...
These terms may be updated. Changes will be reflected in the "last updated" date. The core commitments — no data collection, no clinical claims, open source — are architectural and will not change without the application itself fundamentally changing.
...
*These terms exist to be honest about what this is, protect the people who use it, and protect the person who built it. If that seems unusual for a terms of use document, it's because most terms of use are written to protect companies from the people who use their products. We'd rather protect both.*
